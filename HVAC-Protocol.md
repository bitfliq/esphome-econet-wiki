...
| `ALRMBEEP` |  |
| `SCRNLOCK` |  |
| `TEMPOFFS` | Temperature Offset |
| `DISPUNIT` | Fahrenheit or Celsius | 
| `EQP_NAME` |  |
| `OAT_TEMP` | Outdoor Air Temperature |
| `CI_EMAIL` | Installer Email | 
| `CI__NAME` | Installer Name |
| `CI_COMPN` | Installer Company Name |
| `CI_PHONE` | Installer Phone Number |
...
## Command 30 0x340 to 0x380 TEMPOFFS to CI_PHONE
02.01.00.00.54.45.4D.50.4F.46.46.53.00.00.44.49.53.50.55.4E.49.54.00.00.45.51.50.5F.4E.41.4D.45.00.00.4F.41.54.5F.54.45.4D.50.00.00.43.49.5F.45.4D.41.49.4C.00.00.43.49.5F.5F.4E.41.4D.45.00.00.43.49.5F.43.4F.4D.50.4E.00.00.43.49.5F.50.48.4F.4E.45
</details>
...
|`TEMPOFFS` | `07.80.00.00.C0.00.00.00` | Float | -2 |
|`DISPUNIT` | `0F.82.00.00.00.0A.46.61.68.72.65.6E.68.65.69.74.01.15` | Enumerated Text | Farenheit |
|`EQP_NAME` | `07.80.00.00.42.5A.BD.1D.01.15.01.15.01.15` | ? | ? |
|`OAT_TEMP` | `10.81.00.00.38.30.30.2D.34.33.34.2D.32.37.39.34.00` | Float | 54.684681 |
| `CI_EMAIL` | `` | ? | ? |
|`CI__NAME` | `` | ? | ? |
|`CI_COMPN` | `` | ? | ? |
|`CI_PHONE` | `` | ? | ? |
...
08.82.00.00.00.03.4E.6F.20.07.80.00.00.42.34.00.00.07.80.00.00.40.00.00.00.07.80.00.00.40.A0.00.00.08.82.00.00.00.03.4E.6F.20.12.82.00.00.00.0D.48.65.61.74.20.20.20.20.20.20.20.20.20.07.80.00.00.41.F0.00.00.0B.82.00.00.00.06.4F.66.66.20.20.20.07.80.00.00.40.A0.00.00.08.82.00.00.01.03.59.65.73.08.82.00.00.00.03.4E.6F.20.08.82.00.00.00.03.4E.6F.20
## Command 6 0x380 to 0x340 TEMPOFFS to CI_PHONE
07.80.00.00.C0.00.00.00.0F.82.00.00.00.0A.46.61.68.72.65.6E.68.65.69.74.01.15.07.80.00.00.42.5A.BD.1D.01.15.01.15.01.15.10.81.00.00.38.30.30.2D.34.33.34.2D.32.37.39.34.00
</details>
